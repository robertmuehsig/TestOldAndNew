// This file provides the "missing" types in connection with the Index feature.
...
// Error that is issued when this struct is missing:
// - Error	CS0518	Predefined type 'System.Index' is not defined or imported

// Example usages:
// - Index index = 3;
// - Index index = ^2;
// - int fourthInt = myIntArray[3];
// - int secondLastInt = myIntArray[^2]
